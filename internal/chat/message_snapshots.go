...
const messageSelectColumnsSQL = `m.id, m.room_id, m.client_message_id, m.type, m.body,
	m.mentions_json, m.attachments_json, m.quote_json, m.is_recalled, m.recalled_at,
...
func insertMessageWithSenderSnapshot(
	...
	return insertMessageWithSenderSnapshotAndQuote(
		execer,
		messageID, roomID, senderUserID, clientMessageID, messageType, body,
		mentionsJSON, attachmentsJSON, nil, createdAt,
	)
}

func insertMessageWithSenderSnapshotAndQuote(
	execer messageSnapshotExecer,
	messageID, roomID, senderUserID, clientMessageID, messageType, body,
	mentionsJSON, attachmentsJSON string,
	quoteJSON any,
	...
	return execer.Exec(
		`INSERT INTO messages (
		   ...
		   mentions_json, attachments_json, quote_json, created_at,
