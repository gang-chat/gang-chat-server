...
func RegisterRoutes(g *gin.RouterGroup, db *sql.DB, cfg *config.Config, bus *eventbus.Bus, live liveMediaController, mb *musicbox.Manager, assetStores ...*storage.AssetStorage) *Handler {
	...
	g.POST("/me/music-box/playlists/merge", h.mergeMyMusicPlaylists)
	...
	g.POST("/me/music-box/playlists/:playlist_id/items/batch-add", h.batchAddMyMusicPlaylistItems)
	...
	g.GET("/rooms/:room_id/music-box/playlists", h.listRoomMusicPlaylists)
	g.POST("/rooms/:room_id/music-box/playlists", h.createRoomMusicPlaylist)
	g.POST("/rooms/:room_id/music-box/playlists/merge", h.mergeRoomMusicPlaylists)
	g.POST("/rooms/:room_id/music-box/playlists/:playlist_id/clone-to-me", h.cloneRoomMusicPlaylistToMe)
	g.PATCH("/rooms/:room_id/music-box/playlists/order", h.reorderRoomMusicPlaylists)
	g.GET("/rooms/:room_id/music-box/playlists/:playlist_id", h.getRoomMusicPlaylist)
	g.PATCH("/rooms/:room_id/music-box/playlists/:playlist_id", h.renameRoomMusicPlaylist)
	g.DELETE("/rooms/:room_id/music-box/playlists/:playlist_id", h.deleteRoomMusicPlaylist)
	g.POST("/rooms/:room_id/music-box/playlists/:playlist_id/items", h.addRoomMusicPlaylistItem)
	g.POST("/rooms/:room_id/music-box/playlists/:playlist_id/items/batch-add", h.batchAddRoomMusicPlaylistItems)
	g.DELETE("/rooms/:room_id/music-box/playlists/:playlist_id/items", h.deleteRoomMusicPlaylistItemsBatch)
	g.PATCH("/rooms/:room_id/music-box/playlists/:playlist_id/items/order", h.reorderRoomMusicPlaylistItems)
	g.DELETE("/rooms/:room_id/music-box/playlists/:playlist_id/items/:item_id", h.deleteRoomMusicPlaylistItem)
